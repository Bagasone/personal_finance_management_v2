  ...
  return (
    <div className="flex flex-col justify-center gap-5 pb-20 animate-pulse">
      ...
      <div className="flex flex-col gap-1">
        <div className="h-4 w-36 rounded bg-black-200 mx-1" />
        <div
          className={cn(
          ...
          {Array.from({ length: 3 }).map((_, i) => (
            <div
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="h-3 w-24 rounded bg-black-200" />
              </div>
      ...
      <div className="grid grid-cols-[repeat(2,minmax(50px,1fr))_auto] gap-3 w-full">
      ...
      <div
        className={cn(
          "flex flex-col divide-y divide-black-500",
